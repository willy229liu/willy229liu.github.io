      ...
      window.location.href = "/about/";
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
              window.location.href = "/about/projects/10_project/";
            },},{id: "projects-project-1",
          title: 'project 1',
          description: "with background image",
          section: "Projects",handler: () => {
              window.location.href = "/about/projects/11_project/";
            },},{id: "projects-project-2",
          title: 'project 2',
          description: "a project with a background image and giscus comments",
          section: "Projects",handler: () => {
              window.location.href = "/about/projects/12_project/";
            },},{id: "projects-project-3-with-very-long-name",
          title: 'project 3 with very long name',
          description: "a project that redirects to another website",
          section: "Projects",handler: () => {
              window.location.href = "/about/projects/13_project/";
            },},{id: "projects-project-4",
          title: 'project 4',
          description: "another without an image",
          section: "Projects",handler: () => {
              window.location.href = "/about/projects/14_project/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/about/projects/1_PIP/";
            },},{id: "projects-codecraft-algorithm",
          title: 'CodeCraft Algorithm',
          description: "a project with a background image and giscus comments",
          section: "Projects",handler: () => {
              window.location.href = "/about/projects/2_code_craft/";
            },},{id: "projects-remove-lua-debug-info",
          title: 'Remove Lua Debug Info',
          description: "a project with a background image and giscus comments",
          section: "Projects",handler: () => {
              window.location.href = "/about/projects/3_lua_memory/";
            },},{id: "projects-irbl",
          title: 'IRBL',
          description: "a project with a background image and giscus comments",
          section: "Projects",handler: () => {
              window.location.href = "/about/projects/4_irbl/";
